...
export default function Outputs() {
  ...
  return (
    <div className="p-4 flex flex-col">
      <h3 className="font-bold text-2xl hover:italic hover:translate-x-4 transition">
        <span className="text-4xl text-emerald-600">${total}</span> Yearly
      </h3>
      <h5 className="font-bold text-xl opacity-60 hover:opacity-100 hover:italic hover:translate-x-4 transition">
